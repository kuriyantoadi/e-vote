...
<h2 class="index-header">Selamat Datang di Aplikasi E - Voting<br />SMKN 1 Kragilan</h2>
<div class="row">
    <div class="col-md-4 col-md-offset-1">
        <div id="content-slider">
            <img src="./assets/img/osis.png" class="img" alt="Slideshow 2" >
            <img src="./assets/img/voting.png" class="img" alt="Slideshow 3" >
            <img src="./assets/img/Logo.png" class="img" alt="Slideshow 4" >
    ...
    <div class="col-md-6 form">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="" class="form-control" placeholder="NIS" required="NIS" name="nis"/>
            </div>
            <br />
            <div class="row">
