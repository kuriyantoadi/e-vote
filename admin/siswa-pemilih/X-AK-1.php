...
<div class="row">
   <div class="col-md-9 col-sm-9">
      <h3>Daftar Siswa X AK 1 Sudah Memilih</h3>
   </div>
   ...
   <div class="col-md-10 col-sm-12">
      <table class="table table-striped table-hover">
            ...
            <tbody>
                  ...
                  $sql = mysqli_query($con, " SELECT * FROM t_user inner JOIN t_kelas ON t_user.id_kelas = t_kelas.id_kelas JOIN t_pemilih ON nis=id_user where t_user.id_kelas='K13'");
